Feature: Test the attributes of a given element
    ...
    Scenario:  I expect that the title is "Login to repository"
        Then I expect that the title is "Login to repository"  
        Then I expect that element "#ctl00_ContentPlaceHolder1_txtUsername" becomes visible      
        Then I expect that element "#ctl00_ContentPlaceHolder1_txtUsername" does exist
        Then I expect that the attribute "id" from element "#ctl00_ContentPlaceHolder1_txtUsername" is "ctl00_ContentPlaceHolder1_txtUsername"

...
defineSupportCode(({ Given }) => {
    ...
    Given(
        /^the username for Login$/, function(n){
    ...
    Given(
    /^the password for Login$/, function(m){
    ...
    Given(
        /^click Login button$/, function(k){

           browser.element('//input[@name="ctl00$ContentPlaceHolder1$btnLogin"]').click();
